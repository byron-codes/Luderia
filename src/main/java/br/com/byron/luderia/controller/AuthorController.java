...
import br.com.byron.luderia.service.AuthorService;
...
public class AuthorController extends GenericController<Author, AuthorFilter, AuthorRequest, AuthorResponse> {
	...
	@Autowired
	public AuthorController(AuthorService service, ExecuteStrategy<Author> strategy, IAuthorMapper mapper) {
		super(new Facade<Author, AuthorFilter>(service, strategy), mapper);
	}
